practice_3()
{
	...
	lr_start_transaction("GotoReservations_page1");
	...
	lr_end_transaction("GotoReservations_page1", LR_AUTO);

	
	
	lr_start_transaction("GotoReservations_page2");
	...
	web_submit_data("reservations.pl_2",
		...
		"Mode=HTML",
		ITEMDATA,
		"Name=outboundFlight", "Value=160;431;{departDate}", ENDITEM,
		"Name=numPassengers", "Value=1", ENDITEM,
		"Name=advanceDiscount", "Value=0", ENDITEM,
		"Name=seatType", "Value={seatType}", ENDITEM,
		"Name=seatPref", "Value={seatPref}", ENDITEM,
	...
	lr_end_transaction("GotoReservations_page2", LR_AUTO);

	
	
	lr_start_transaction("GotoReservations_page3");
	...
	web_submit_data("reservations.pl_3",
		...
		"Name=JSFormSubmit", "Value=off", ENDITEM,
		"Name=buyFlights.x", "Value=21", ENDITEM,
	...
	lr_end_transaction("GotoReservations_page3", LR_AUTO);
